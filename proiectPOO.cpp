...
private:
    ...
    string nume;
    array<string, max_serviciiAlese> reclameDejaFolosite;
    string email;
    string telefon;
    unique_ptr<string[]> serviciuAles;
...
public:
    ...
    array<string, max_serviciiAlese> get_reclameDejaFolosite()
    {
...
public:
    void adaugaServiciu(T* serviciu)
    {
        if (serviciu == nullptr)
        {
            throw invalid_argument("Serviciu nul.");
        }
...
//lista Reclame="Instagram Ads","Facebook Ads","Google Ads","Creare Website","Youtube Ads"
{
    ...
    cout << "Numar obiecte PachetServicii: " << PachetServicii<Logo>::getNumarObiecte() <<endl;
    ...
    cout << "Reclamele inainte de sortare:" << endl;
    for (const auto& reclama : reclameSortate)
    {
        cout << reclama.get_platformaReclama() << " - Impact: " << reclama.get_impact() << endl;
    }

    sort(reclameSortate.begin(), reclameSortate.end(), comparareImpact);

    cout << endl << "Reclamele dupa sortare:" << endl;
    for (const auto& reclameSortata : reclameSortate)
    {
        cout<< reclameSortata.get_platformaReclama() << " - Impact: " << reclameSortata.get_impact() << endl;
    }
