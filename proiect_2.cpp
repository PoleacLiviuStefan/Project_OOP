...
private:
    ...
    string nume;
    string reclameDejaFolosite[5],email,telefon;
    string* serviciuAles;
...
public:
    ...
    {
        nume = c.nume;
        numarReclameDejaFolosite = c.numarReclameDejaFolosite;
        for (int i = 0; i < c.numarReclameDejaFolosite; i++)
            reclameDejaFolosite[i] = c.reclameDejaFolosite[i];
        email = c.email;
        telefon = c.telefon;
        websiteExistent = c.websiteExistent;
        capitalReclame = c.capitalReclame;
...
{
    static int numarObiecte; // variabila membru statica
...
public:
    ...
    {
        return numarObiecte;    // metoda pentru accesarea variabilei membru statice
    }
};

int PachetServicii::numarObiecte = 0;
...
//lista Reclame="Instagram Ads","Facebook Ads","Google Ads","Creare Website","Youtube Ads"
{
    ...
    Angajat* angajat = new AngajatNou({"Task1", "Task2"});
    ...
    pachet.adaugaServiciu(new Banner());
    pachet.adaugaServiciu(new SEO());
    ...
    AngajatNou angajatNou2({ "task1", "task2" });
    try
    {
    ...
    PachetServicii pachet1; // se creaza primul obiect din clasa PachetServicii
    PachetServicii pachet2; // se creaza al doilea obiect din clasa PachetServicii

    cout << "Numar obiecte PachetServicii: " << PachetServicii::getNumarObiecte() << endl; // se afiseaza numarul de obiecte creat

    cout << "Costul total al pachetului de servicii este: " << costTotal << endl;

    PachetServicii pachet3;
    pachet3.adaugaServiciu(new Logo());
    pachet3.adaugaServiciu(new Banner());
    pachet3.adaugaServiciu(new SEO());

    cout << "Costul total al pachetului de servicii este: " << pachet3.calculeazaCostTotal() << endl;
    ...
    Reclama reclama1("Facebook", 0.20, 1200, 80);
